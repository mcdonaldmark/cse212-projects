...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Original code did not remove people and caused missing elements.
    ...
    // Defect(s) Found: Did not update properly and order was out of order.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite turns were not used.
    ...
    // Defect(s) Found: Infinite turns not used.
    ...
    // Defect(s) Found: Exception was not shared.
